...
class ConditionalBatchNorm2d(nn.Module):
  def __init__(self, num_features, num_classes, bias=True):
    ...
    if self.bias:
      ...
      self.embed.weight.data[:, :num_features].uniform_()  # Initialise scale at N(x, 0.02)
...
class ConditionalInstanceNorm2dPlus(nn.Module):
  def __init__(self, num_features, num_classes, bias=True):
    ...
    if bias:
      ...
      self.embed.weight.data[:, :2 * num_features].normal_(1, 0.02)  # Initialise scale at N(x, 0.02)
